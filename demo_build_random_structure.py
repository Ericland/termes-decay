...
# In[]
bp = generate_random_blueprint((5, 5), make_plot=True, save_data=True)
...
tw, sh, rh = simInfo 
visualize_construction(tw.start_struct, tw.goal_struct, sh, rh, style='2d', frame_sampling_period=10, video_format='gif')
visualize_construction(tw.start_struct, tw.goal_struct, sh, rh, style='3d', frame_sampling_period=10, video_format='gif')
